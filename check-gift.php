                ...
                <div class="px-3">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="py-3 py-lg-4">
                            <div class="row">
                                <div class="col-lg-6">
                                    <h4 class="page-title mb-0">Gift check form</h4>
                                </div>
                                <div class="col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Check Customer Gift</h4>
                                        <p class="sub-header">
                                            User can check customer gift earn in Luckydraw.
                                        </p>
                                        <form class="row row-cols-lg-auto g-8 align-items-center">
                                            <div class="col-12">
                                                <label for="staticEmail2" class="visually-hidden">IMEI</label>
                                            ...
                                            <button type="submit" class="btn btn-primary">Check Gift</button>
                                        </form>
                                        <br>
                                        <br>
                                    <div id="dataview"><p>Customer gift data will show here</p></div>
                                    </div>
                                </div>
                            </div>
                        </div>
